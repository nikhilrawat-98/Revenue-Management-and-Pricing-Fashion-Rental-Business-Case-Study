...
TT=1800; # Length of time horizon
prob0=0.2; # No customer
prob1=0.5; # Premium customer
prob2=0.3; # Regular customer
price1=120; # the price for Premium customer
price2=90; # the price for Regular customer
